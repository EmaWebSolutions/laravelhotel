            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="inn-com-form">
                       <form action="{{ url('room_type/'.$room_type->id.'/book') }}" method="POST" class="col s12">
                       @method('POST')
                       @csrf
                        ...
                        <div class="row">
                                <div class="input-field col s12 m4 l2">
                                    <input type="text" style="color: black" value="{{$room_type->finalPrice.' '.config('app.currency') }}" class="form-btn" disabled>
                                </div>
                                <div class="input-field col s12 m4 l2">
                                    <select name="number_of_adult">
                                        <option value="" disabled selected>No of adults</option>
                                        @for($i = 1; $i <= $room_type->max_adult; $i++ )
                                       <option value="{{ $i }}" @if (old('number_of_adult') == $i) selected="selected" @endif>{{ $i }}</option>
                                ...
                                <div class="input-field col s12 m4 l2">
                                    <select name="number_of_child">
                                        ...
                                        @for($i = 0; $i <= $room_type->max_adult; $i++ )
                                           <option value="{{ $i }}" @if (old('number_of_child') == $i && old('number_of_child') != 0 ) selected="selected" @endif>{{ $i }}</option>
